...
void CGameTypeSelect::Enter () {
	...
	int top = (Winsys.resolution.height - (dist * 7)) / 2;
	textbuttons[0] = AddTextButton (Trans.Text(2), CENTER, top, siz);
	textbuttons[1] = AddTextButton (Trans.Text(1), CENTER, top + dist, siz);
	textbuttons[2] = AddTextButton (Trans.Text(62), CENTER, top + dist * 2, siz);
	textbuttons[3] = AddTextButton (Trans.Text(3), CENTER, top + dist * 3, siz);
	textbuttons[4] = AddTextButton (Trans.Text(92), CENTER, top + dist * 4, siz);
